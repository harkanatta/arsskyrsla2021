...
.split-two.border-white[
.column[
Undanfarin ár hafa steingervingar verið athugaðir í Bakkabrúnum. Þar finnast vel varðveitt blaðför meðal annars af birki og elri. Steingervingarnir eru frá hlýskeiði ísaldar.
]
...
---
layout:false
class: split-50 bg-white with-border bottom
background-image: url(myndir/ashildur.JPEG)
background-size: cover
