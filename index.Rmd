...
layout:false
class: split-50 bg-white with-border
...
Sett var upp vefsíða fyrir verkefnið [„Youth for Arctic Nature“](https://www.arcticnature.org/) sem er unnið í samstarfi við Húnaklúbbinn á Hvammstanga og styrkt af sjóðnum NORA og loftslagssjóðnum.
...
---
layout:false
class: split-40 bg-white with-thick-border middle
background-size: cover
...
Starfsmenn náttúrustofunnar tóku þátt í **arnarmerkingum** með starfsmönnum Náttúrufræðistofnun Íslands. Alls voru merktir arnarungar á 4 hreiðrum á okkar svæði. Ernir sáust víða og má teljast merkilegt hvað þeir eru tíðir á Arnarvatnsheiði og á Miðhálendinu t.d. Ásbjarnarvötn í um 700 mys.
...
Elínór. Fullorðinn fálkakarl fannst slasaður í Hrútafirði. Hann var fóðraður og hjúkrað í nokkrar vikur og komið til heilsu. Hann var svo fluttur í Húsdýragarðinn. 
]
]
...
.row[
  .split-three.with-thick-border[
  .column[.nopadding[
.footnote.large[Blaðfar, birki. Bakkabrúnir í Víðidal]
...
.column.bg-white[.nopadding[
.footnote.large[Surtarbrandur úr Hrútagili í Vesturdal]
 .img-fill[![](myndir/breyttar/surtarbrandur.JPEG)]
  ...
  .column.bg-white[.nopadding[
.footnote.white.large[Geislasteinn fundinn í Hegranesi]
...
.row[
  ...
  .justify-right.footer-note[**Náma við Friðmundarvötn**]
...
.footer-note.white[Hafnargarðurinn á Skagaströnd]
  ]]
...
.yellow.font2[Hið smásæja er einnig í stöðugri skoðun en náttúrustofan tekur þátt í greiningum á botndýrum í sjó og lítillega fengist við greiningar á smádýrum úr vötnum]
...
Gargönd nokkuð sást af gargöndum í Skagafirði en þar verpa fáeinir tugir para þessarar annars fágætu andategundar sem annars er aðallega bundin við Mývatn og Laxá ásamt Aðaldal. Grafendur finnast nokkuð víða um héraðið en eru þó mjög fáliðaðar þó nóg sé kjörlendið í Eylendi Skagafjarðar og votlendi í Vatnsdal.
 ...
 fálki minna um varp en undanfarin ár enda er fremur lítið af rjúpum sem eru mikilvægasta fæða fálkans. 
...
Skollaber eru frekar sjaldgæf hér á landi og vaxa innan um lyng. Þau finnast á fáeinum stöðum við Hrútafjörð og á Skaga en eru nokkuð algeng á Tröllaskaga Skagafjarðarmegin.

---
class: inverse, middle, center

# Mjög fallegt stuðlaberg finnst á nokkrum stöðum. Þekktustu staðirnir eru Hofsós, Kálfshamarsvík og Borgarvirki. Færri vita af geisifallegu stuðlabergi í Nesbjörgum í Vesturhópi eða Káraborg á Vatnsnesi, eins má nefna merkilegt stuðlaberg í stórri námu hjá Friðmundarvötnum á Auðkúluheiði við leiðina um Kjalveg. Eða merkilegt stuðlaberg sem að hafnargarðurinn á Skagaströnd er byggður utan í.
...
.large[
  ...
  - International Symposium on Plastics in the Arctic and Sub-Arctic Region on March 2-4 and 8-9, 2021
  - Ársfundur NÍ og náttúrustofa 19. október. 2021 að Laugarbakka í Miðfirði
  - um náttúruvernd
  
  
Fuglar á Skagaströnd
Ráðstefna (meðhöfundur)

Conferences and talks
1. 8th of April 2021: Íslenskar æskulýðsrannsóknir: Hvert er ferðinni heitið?
Chauvat & Aquino. Using Place-based education projects to engage youth in Arctic nature.
2. 6th of May 2021: Polar Early Career Conference
Chauvat, Aquino and Granquist. Analyzing visitors' values and perceptions to inform management at seal watching sites in northwestern Iceland.
...
.column.bg-main1[.content.vmiddle.center.nopadding[
.footnote.white[Dróni var keyptur í tengslum við Vöktun náttúruverndarsvæða árið 2020 og hefur verið notaður við kortlagningu og ýmislegt fleira]
...
.column[.content.nopadding[
    ...
    .img-fill[![](myndir/breyttar/gullspora.png)]
